...
tabula_jar_path = "/tmp/tabula-1.0.5-jar-with-dependencies.jar"
java_executable = "java"
java_options = ["-Dfile.encoding=UTF8", "-jar", "/home/user/alx/Autocorrect_QCM/tabula-1.0.5-jar-with-dependencies.jar"]
