...
def correct_quiz():
    ...
    # Afficher le nombre total de fichiers PDF
    display_pdf_count()

    # Compter les fichiers PDF dans le répertoire QCM_pdfs
    ...
    if feuilles_corrigees < pdf_count:
        ...
        root.after(1000, correct_quiz)  # Attendre 1 seconde avant de corriger la feuille suivante
    else:
