...
def create_gui():
    ...
    select_pdfs_button.grid(row=2, column=0, padx=10, pady=10)
    ...
    select_correct_file_button.grid(row=2, column=1, padx=10, pady=10)

    # Bouton 4 : Corriger
    correct_button = tk.Button(root, text="Corriger", command=correct_quiz)
    correct_button.grid(row=3, column=0, padx=10, pady=10)
